...
function Cards() {
  return (
    <div className='flex justify-around flex-wrap gap-8 bg-white'>
      <div className="card group bg-white w-96 shadow-sm border-[#eaeaea] transition-shadow duration-300 hover:shadow-[0_8px_24px_0_rgba(0,142,214,0.20)]">
      ...
      <div className="card group  w-96 shadow-sm border-[#eaeaea] transition-shadow duration-300 hover:shadow-[0_8px_24px_0_rgba(0,142,214,0.20)] bg-white">
        <figure className='mt-1.5'>
          <img
            src="card(3).jpg"
            alt="Shoes"
